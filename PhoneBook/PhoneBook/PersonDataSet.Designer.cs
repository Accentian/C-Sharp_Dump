...
namespace PhoneBook {
    ...
    public partial class PersonDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public PersonRow AddPersonRow(int PersonID, string Name, string Phone) {
...
namespace PhoneBook.PersonDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([PersonID], [Name], [Phone]) VALUES (@PersonID, @Name" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [PersonID] = @PersonID, [Name] = @Name, [Phone] = @Phone WHERE (([PersonID] = @Original_PersonID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT PersonID, Name, Phone FROM Person WHERE (PersonID = @PersonID)";
        ...
        public virtual int Insert(int PersonID, string Name, string Phone) {
        ...
        public virtual int Update(int PersonID, string Name, string Phone, int Original_PersonID, string Original_Name, string Original_Phone) {
        ...
        public virtual int Update(string Name, string Phone, int Original_PersonID, string Original_Name, string Original_Phone) {
            return this.Update(Original_PersonID, Name, Phone, Original_PersonID, Original_Name, Original_Phone);
        }
    }
